...
#define kAllHeight          ([UIScreen mainScreen].bounds.size.height + 20.0)
...
#define K_SafeAreaTopHeight ((kScreenHeight == 812 || kScreenHeight == 896) ? 88 : 64)
#define K_SafeAreaBottomHeight ((kScreenHeight == 812 || kScreenHeight == 896) ? 34 : 0)


#define AdapterTableSystem self.backViewTopConstraint.constant = SafeAreaTopHeight;\
if (@available(iOS 11.0, *)) {}else {\
    self.backViewTopConstraint.constant = 44;\
}
#define AdapterSystem self.backViewTopConstraint.constant = SafeAreaTopHeight;

#define PushControllerHidesBottomBar(vc) vc.hidesBottomBarWhenPushed = YES;\
[self.navigationController pushViewController:vc animated:YES];
#define PushController(vc) [self.navigationController pushViewController:vc animated:YES];


//状态栏:20  导航栏:44  Tabbar:49   以320X480为例  applicationFrame：460（除去了状态栏高度20）   bounds：480
...
#define ISIOS9 ([[[UIDevice currentDevice] systemVersion] floatValue] >= 9.0) // IOS8的系统
#define LT_IOS11 ([[[UIDevice currentDevice] systemVersion] floatValue] < 11.0) // 小于IOS11的系统
...
#define WEAKOF(weakSelf) __weak typeof(self) weakSelf = self;


/** 极光推送用户名 */
#define JpushUserid @"userid"
#define JpushUserid_temp @"userid_temp"
#define DB_Version @"db_version"

#define APPSTORE_URL @"https://itunes.apple.com/us/app/gei-le-hui-yuan-shou-ji-zhong/id735889083?ls=1&mt=8"

#define GUIDE_SHOW_NAME @"guide_show_name"
#define USERID [[NSUserDefaults standardUserDefaults] objectForKey:JpushUserid]
#define SystemNotiTableName @"systemNoti"
#define BillNotiTableName [[NSUserDefaults standardUserDefaults] objectForKey:@"bill"]
